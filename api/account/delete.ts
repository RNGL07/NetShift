...
export default withErrorHandling('account.delete', async (req: VercelRequest, res: VercelResponse) => {
  ...
  if (error) {
    ...
    throw new ApiError('server_error', 'Your account could not be deleted. Please contact support.');
  }
